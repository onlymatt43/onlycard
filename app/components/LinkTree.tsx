...
import FloatingMetaCards from './FloatingMetaCards';
import PayOnlyMatt from './PayOnlyMatt';
        ...
        {eventTitle && (
          eventUrl ? (
            <a
              ...
              className="mt-3 inline-block rounded-full border border-emerald-400/30 bg-emerald-400/10 px-3 py-1 text-emerald-200 uppercase transition-colors hover:bg-emerald-400/20 relative z-10"
              style={{ fontSize: 'clamp(0.56rem, 1.2vmin, 0.72rem)', letterSpacing: '0.14em' }}
            >
              LIVE @ {eventTitle}
            </a>
          ) : (
            <span
              className="mt-3 inline-block rounded-full border border-emerald-400/30 bg-emerald-400/10 px-3 py-1 text-emerald-200 uppercase relative z-10"
              style={{ fontSize: 'clamp(0.56rem, 1.2vmin, 0.72rem)', letterSpacing: '0.14em' }}
            >
              LIVE @ {eventTitle}
            </span>
